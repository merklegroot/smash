 ...
 *
 * Source of truth: `data/training-sets-defaults.json`. Every entry is an N5 training set
 * (JLPT N5-only kanji from `data/n5.json`), ordered for level labels 1-1, 1-2, … in Smash.
 * Themed after a common N5 study breakdown; each set only includes characters that exist in
 * `data/n5.json`. Omitted:
